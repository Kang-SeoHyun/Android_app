...
public class GPSTracker extends Service implements
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isGPSEnabled) {
                    if (myLocation == null) {
                        ...
                        myLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, MIN_TIME_UPDATES,
    ...
    public void showSettingAlert() {
        ...
        alertDialog.setMessage("GPS 는 활성화되지 않았습니다. 설정메뉴로 이동할까요 ? ");
