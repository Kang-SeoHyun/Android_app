...
public class StudentDBManager extends SQLiteOpenHelper {
    ...
    public static StudentDBManager getInstance(Context context) {
        if (dbManager == null) {
            dbManager = new StudentDBManager(context,
                    STUDENT_DB, null, 1);
        }
        return dbManager;
    }

    public StudentDBManager(Context context, String dbName,
    ...
    public long insert(ContentValues addValue) {
        return getWritableDatabase().insert(STUDENT_TABLE,
                null, addValue);
    }
    ...
    public Cursor query(String[] columns, String selection,
                        ...
                        String orderBy) {
        return getReadableDatabase().query(STUDENT_TABLE,
                columns, selection, selectionArgs, groupBy, having, orderBy);
    }

    public int delete(String whereClause, String[] whereArgs) {
        return getWritableDatabase().delete(STUDENT_TABLE,
