...
public class MyContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME ="com.course.afinal.MyContentProvider";
    static final String URL = "content://" + PROVIDER_NAME + "/travels";
    ...
    public ListDBmanager dbManager;
    ...
    public boolean onCreate() {
        dbManager = ListDBmanager.getInstance(getContext());
        return true;
    }
